...
public final class Testo {
    ...
    private static double costoTaglio(String s,int p){if(p>0&&SEPARATORI.indexOf(s.charAt(p-1))>=0)return -18;if(p<s.length()&&SEPARATORI.indexOf(s.charAt(p))>=0)return -5;return 25;}
