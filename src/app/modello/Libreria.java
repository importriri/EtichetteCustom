...
/**
 * Le etichette di partenza.
 *
 * Sono volutamente diverse fra loro - un articolo, un imballo, un posto a
 * scaffale, un cespite, una targhetta minima - perche' il programma non
 * deve dare per scontato che cosa si stia etichettando.
 */
